      ...
      (n.init = function () {
        ...
        (n.onFocus = function () {
          (n.animating || n.elem.value === n.placeholder) &&
            ((n.animating = 1), window.cancelAnimationFrame(n.rAF), n.deletePlaceholder(), n.restoreDefaultType());
        }),
        (n.onBlur = function () {
          (n.animating || '' === n.elem.value) &&
            ((n.animating = 1), window.cancelAnimationFrame(n.rAF), n.restorePlaceholder(), n.resetDefaultType());
        }),
        ...
        (n.deletePlaceholder = function () {
          n.elem.value.length > 0
            ? ((n.elem.value = n.elem.value.slice(0, -1)), (n.rAF = window.requestAnimationFrame(n.deletePlaceholder)))
            : (n.animating = 0);
        }),
        ...
        (n.resetDefaultType = function () {
          -1 != t.customElems.indexOf(n.defaultInputType) &&
            (n.elem.setAttribute(t.defaultInputAttributeName, n.defaultInputType), n.elem.setAttribute('type', 'text'));
        }),
        n.init();
    }),
    t.init(),
