!(function (a) {
  a.fn.stellarNav = function (n, i, s) {
    ...
    return this.each(function () {
      ...
      if (
        (nav.prepend('<a href="#" class="menu-toggle ' + t + '"><i class="fa fa-bars"></i> Menu</a>'),
      ...
      'right' == e.position && nav.addClass('right'),
        ...
        e.closeBtn &&
          ...
          nav
            .find('ul:first')
            .append('<li><a href="#" class="close-menu"><i class="fa fa-close"></i> Close Menu</a></li>'),
                  ...
                  a(document).on('click', function (n) {
                    nav.hasClass('mobile') &&
                      (a(n.target).closest(nav).length ||
                        (nav.find('ul:first').stop(!0, !0).fadeOut(250), nav.removeClass('active')));
                  }))
        ...
        a('.close-menu').click(function () {
          nav.removeClass('active'),
            'left' == e.position || 'right' == e.position
              ? nav.find('ul:first').stop(!0, !0).fadeToggle(250)
              : nav.find('ul:first').stop(!0, !0).slideUp(250).toggleClass('active');
        }),
        nav.find('li a').each(function () {
          a(this).next().length > 0 &&
            a(this)
              .parent('li')
              .addClass('has-sub')
              .append('<a class="dd-toggle" href="#"><i class="fa fa-plus"></i></a>');
        }),
