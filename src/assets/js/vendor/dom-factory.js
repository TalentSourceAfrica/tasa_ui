  ...
  return (function (t) {
          ...
          var o = e(4),
                  ...
                  h(t, function (e, o, i, u) {
                    if ((p(t, e, i, u, o), 0 !== r && i && (f(i) || a(i)))) {
                      ...
                      for (var l = s ? s.length : 0, v = 0; l > v; v++)
                        ...
                        else for (var d = 0; d < i.length; d++) g(i[d], s[v], void 0 === r ? r : r - 1);
                    }
                  })),
                void 0 === t.__proxy__ && l(t, '__proxy__', {}),
                void 0 === t.__watchers__[n] && ((t.__watchers__[n] = []), u || (o = !0));
            ...
            b = function (t, n, e, r) {
              'string' != typeof t &&
                ...
                (s(t[n]) ||
                  (null !== t[n] && (void 0 === r || r > 0) && g(t[n], e, void 0 !== r ? r - 1 : r), y(t, n, e, r)));
            },
            _ = function (t, n, e, r) {
          ...
          (d =
            ...
            ''.split(/.?/).length
              ? function (t, n) {
                  ...
                  return (
                    l === o.length ? (!c && d.test('')) || a.push('') : a.push(o.slice(l)),
          ...
          [
            ...
            function (t, n) {
              ...
              for (var m = 0, x = 0, w = []; x < p.length; ) {
                ...
                var O,
                  S = a(b, v ? p : p.slice(x));
                if (null === S || (O = l(c(b.lastIndex + (v ? 0 : x)), p.length)) === m) x = u(p, x, y);
                else {
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var m, x = '', w = 0, O = 0; O < b.length; O++) {
              _ = b[O];
              for (var S = String(_[0]), E = f(s(u(_.index), p.length), 0), j = [], A = 1; A < _.length; A++)
                j.push(void 0 === (m = _[A]) ? m : String(m));
              var P = _.groups;
              if (v) {
        ...
        return function (n, c, d) {
          for (
            var h,
              ...
              m = u(b.length),
              x = 0,
              w = e ? v(n, m) : a ? v(n, 0) : void 0;
            m > x;
            x++
          )
            if ((p || x in b) && ((y = _((h = b[x]), x, g)), t))
              if (e) w[x] = y;
              else if (y)
                switch (t) {
                  case 3:
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e, d, h, y, g) {
        ...
        if (
          (I &&
            (m = s(I.call(new t()))) !== Object.prototype &&
            m.next &&
            (f(m, w, !0), r || 'function' == typeof m[l] || u(m, l, v)),
          O &&
            j &&
            'values' !== j.name &&
            ((S = !0),
          ...
          if (((b = { values: O ? A : x('values'), keys: y ? A : x('keys'), entries: P }), g))
      ...
      t.exports = {
        set:
          ...
          ('__proto__' in {}
            ? (function (t, n, r) {
                try {
                  (r = e(24)(Function.call, e(49).f(Object.prototype, '__proto__').set, 2))(t, []),
            ...
            var r = l('data-'.concat(t)),
              ...
              i = {
                ...
                set: function (e) {
                  var o = !e && 0 !== e;
                  if (n.type === Boolean || o)
                    return this.element[o ? 'removeAttribute' : 'setAttribute'](r, n.type === Boolean ? '' : e);
        ...
        x = function (t, n) {
          if (t && 'object' === u()(t) && a(n)) {
            ...
            var e = {
              $set: function (t, n) {
                if (t && void 0 !== n && void 0 !== this.properties && this.properties.hasOwnProperty(t)) {
                  ...
                  if (e.readOnly && void 0 !== r.writable) {
                    var o = { enumerable: r.enumerable, configurable: r.configurable, writable: !1, value: n };
              ...
              fire: function (t) {
                var n;
                if ('CustomEvent' in window && 'object' === u()(window.CustomEvent))
                  try {
        ...
        E = {
              ...
              if (!o || (null !== r && -1 !== r.indexOf(n))) {
                ...
                if (u) {
                  ...
                  delete c.factory,
                    ...
                    Object.defineProperty(t, S(n), { configurable: !0, writable: !1, value: u }),
          ...
          upgrade: function (t) {
            ...
            if (void 0 === t) this.upgradeAll();
              ...
              var e = this.findRegistered(t);
              if (e)
                O()(document.querySelectorAll('.' + e.cssClass)).forEach(function (e) {
