  ...
  return (function (t) {
    ...
    function (t, e, n) {
      for (
        ...
        var g,
          ...
          y = s[m],
          w = y && y.prototype;
        if (w && (w[l] || a(w, l, h), w[f] || a(w, f, m), (c[m] = h), v)) for (g in r) w[g] || o(w, g, r[g], !0);
      }
    },
    function (t, e, n) {
      var r = n(12),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, p, _, g, m) {
        ...
        if (
          (D &&
            (w = l(D.call(new t()))) !== Object.prototype &&
            w.next &&
            (u(w, T, !0), r || 'function' == typeof w[f] || s(w, f, d)),
          x &&
            C &&
            'values' !== C.name &&
            ((S = !0),
          ...
          var i = n(4),
            ...
            c =
              ((e.watch = function () {
                ...
                var r = e[1];
                l(r) ? m.apply(void 0, e) : c(r) ? y.apply(void 0, e) : v.apply(void 0, e);
              }),
              (e.unwatch = function () {
                for (var t = arguments.length, e = Array(t), n = 0; t > n; n++) e[n] = arguments[n];
                var r = e[1];
                l(r) || void 0 === r ? T.apply(void 0, e) : c(r) ? b.apply(void 0, e) : w.apply(void 0, e);
              }),
              function (t) {
            ...
            p = function (t, e, n, r) {
              f(t, n, function () {
                for (var i = 0, o = void 0, s = void 0, a = arguments.length, c = Array(a), u = 0; a > u; u++)
                  c[u] = arguments[u];
                if ('splice' === n) {
                  var l = c[0],
                    f = l + c[1];
                  ...
                  _(t, function (n, i, o, s) {
                    if ((h(t, n, o, s, i), 0 !== r && o && (u(o) || c(o)))) {
                      ...
                      for (var f = l ? l.length : 0, d = 0; f > d; d++)
                        if ('splice' !== i) m(o, l[d], void 0 === r ? r : r - 1);
                        else for (var p = 0; p < o.length; p++) m(o[p], l[d], void 0 === r ? r : r - 1);
                    }
                  })),
                void 0 === t.__proxy__ && f(t, '__proxy__', {}),
                void 0 === t.__watchers__[e] && ((t.__watchers__[e] = []), s || (i = !0));
              for (var l = 0; l < t.__watchers__[e].length; l++) if (t.__watchers__[e][l] === n) return;
            ...
            v = function (t, e, n, r) {
              'string' != typeof t &&
                ...
                (l(t[e]) ||
                  (null !== t[e] && (void 0 === r || r > 0) && m(t[e], n, void 0 !== r ? r - 1 : r), g(t, e, n, r)));
            },
            y = function (t, e, n, r) {
    ...
    function (t, e, n) {
      ...
      t.exports =
        ...
        function (t, e) {
          var n;
          return (
            null !== t ? ((a.prototype = r(t)), (n = new a()), (a.prototype = null), (n[s] = t)) : (n = c()),
            void 0 === e ? n : i(n, e)
          );
        };
    },
        ...
        a = {
          ...
          run: function (t, e) {
            ...
            [
              ...
              t &&
                ((t.style.marginTop = ''.concat(-1 * o, 'px')), n._transform('translate3d(0, '.concat(c, 'px, 0)'), t));
            });
          ...
          (p =
            ...
            ''.split(/.?/).length
              ? function (t, e) {
                  ...
                  return (
                    f === i.length ? (!a && p.test('')) || c.push('') : c.push(i.slice(f)),
      ...
      ((e = t.exports = function (t, e, n, f, h) {
        ...
        if (o(m)) {
          for (d = a(t.length); d > y; y++)
            if ((g = e ? v(s((p = t[y]))[0], p[1]) : v(t[y])) === u || g === l) return g;
        } else for (_ = m.call(t); !(p = _.next()).done; ) if ((g = i(_, v, p.value, e)) === u || g === l) return g;
      }).BREAK = u),
        (e.RETURN = l);
    },
    function (t, e, n) {
      ...
      t.exports = {
        set:
          ...
          ('__proto__' in {}
            ? (function (t, e, r) {
                try {
                  (r = n(18)(Function.call, n(60).f(Object.prototype, '__proto__').set, 2))(t, []),
          ...
          setUp: function () {
            ...
            e.forEach(function (e) {
              if (e) {
                ...
                e.hasAttribute('id') ||
                  ((n = 'rt' + (0 | (9e6 * Math.random())).toString(36)), e.setAttribute('id', n));
                  ...
                  !(function (t, e, n, r) {
                    ...
                    function (t, e, r) {
                      (i.style.willChange = 'transform'),
                        ...
                        (t = t.toFixed(5)),
                        n._transform(
                          'translate('.concat(e, 'px, ').concat(r, 'px) scale3d(').concat(t, ', ').concat(t, ', 1)'),
                          i
                        );
                    }
                  );
      ...
      var s = [
        {
          ...
          run: function (t, e) {
            this._primary.classList[this.isOnScreen() && this.isContentBelow() ? 'add' : 'remove'](
          ...
          var e = {
            ...
            _reset: function () {
              this._removeListener(),
                ...
                this.query &&
                  ((this._mq = window.matchMedia(this.query)), this._addListener(), this._handler(this._mq));
            },
            _handler: function (t) {
          ...
          this.RetargetMouseScroll = function (e, n, r, i, o) {
            ...
            return (
              (s = e.addEventListener)
                ...
                : (s = e.attachEvent) && s.call(e, 'on' + t[1], u),
          ...
          return (
              ...
              _handleFixedPositionedScroll: function () {
                void 0 !== this._fixedPositionedScrollHandler && this._fixedPositionedScrollHandler.restore(),
                  this._isValidScrollTarget() &&
                    this._isPositionedFixedEmulated &&
                    this.scrollTarget !== this._doc &&
                    (this._fixedPositionedScrollHandler = Object(l.RetargetMouseScroll)(
                      this.element,
                      this.scrollTarget
                    ));
              },
            ...
            s()(e, '_updateScrollState', function (t, e) {
              if (0 !== this._height && !this.disabled && (e || t !== this._lastScrollTop)) {
                ...
                if (
                  ...
                  this.reveals &&
                    a < 100 &&
                    ((u - this._initTimestamp > 300 || this._wasScrollingDown !== c) &&
                ...
                if (this._isPositionedAbsolute) {
                  ...
                  return (
                    ...
                    void (
                      ...
                      this._transform(
                        'translate3d(0, '.concat(Math.min(t, this._dHeight) - this._primaryTop, 'px, 0)'),
                        this._primary
                      ))
                    )
                  );
            ...
            s()(e, 'init', function () {
              ...
              (this._resizeWidth = window.innerWidth),
                ...
                this._primary.classList[this.fixed || this.condenses ? 'add' : 'remove'](v),
            ...
            start: function () {
              this.stop(),
                this._items.length < 2 ||
                  ...
                  (this._setContentTransitionDuration(''), (this._interval = setInterval(this.next.bind(this), 2e3)));
            },
            stop: function () {
    ...
    function (t, e, n) {
      n(2) && 'g' != /./g.flags && n(7).f(RegExp.prototype, 'flags', { configurable: !0, get: n(56) });
    },
    function (t, e, n) {
      'use strict';
      var r = n(18),
        ...
        'Array',
        {
          from: function (t) {
            ...
            if ((g && (_ = r(_, p > 2 ? arguments[2] : void 0, 2)), null == v || (d == Array && a(v))))
              for (n = new d((e = c(h.length))); e > m; m++) u(n, m, g ? _(h[m], m) : h[m]);
            else
              for (f = v.call(h), n = new d(); !(i = f.next()).done; m++)
                u(n, m, g ? s(f, _, [i.value, m], !0) : i.value);
            return (n.length = m), n;
          },
        }
      );
